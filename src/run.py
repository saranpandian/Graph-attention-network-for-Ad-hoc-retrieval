...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        for idx in tqdm(range(n_batch)):
            ...
            adj_mat_pos = GD.adjacent(unique_words_pos,pos_doc_list)

            unique_words_neg = words_lookup(neg_docs)
            neg_doc_list = []
            for doc in neg_docs:
                neg_doc_list.append(doc_dict[doc])
            adj_mat_neg = GD.adjacent(unique_words_neg,neg_doc_list)
            ...
            pos_scores = model(adj_mat_pos, qrls_words, pos_docs_words, pos_docs)
            neg_scores = model(adj_mat_neg, qrls_words, neg_docs_words, neg_docs)
